...
One can set (residual) type to be either "Regular" (the default), "Standardized", or "Studentized". 
...
The color used in the plots can be changed from the default of "steelblue" by providing a different value for the col parameter in the function call.
